...
case class Field(var x:Int, var y :Int, var mine :Int) extends FieldInterface{
  ...
  override def set(row: Int, col: Int, isVisible: Boolean, state: Int, flag: Boolean) = this
